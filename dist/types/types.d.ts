...
export type SseEventName = 'start' | 'token' | 'thinking' | 'metadata' | 'tool' | 'usedTools' | 'calledTools' | 'agentReasoning' | 'nextAgent' | 'sourceDocuments' | 'artifacts' | 'fileAnnotations' | 'action' | 'abort' | 'usageMetadata' | 'tts_start' | 'tts_data' | 'tts_end' | 'tts_error' | 'error' | 'end';
